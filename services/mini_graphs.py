...
items_graph.add_node('apple', props={'name': 'apple'})
...
recipes_graph.add_node(
    'wooden_pickaxe', props={
        'provides': {
            'quantity': 1, 'name': 'wooden_pickaxe'}, 'needs': [
                {
                    'name': 'stick', 'quantity': 2}, {
                        'name': 'plank', 'quantity': 3}]})
recipes_graph.add_node('stick', props={'provides': {
                       'quantity': 4, 'name': 'stick'}, 'needs': [{'name': 'plank', 'quantity': 2}]})
recipes_graph.add_node('plank', props={'provides': {
...
# money -> debit -> all items
trade_graph.add_node('bid', props={'name': 'bid'})
# inventory items -> credit -> money
trade_graph.add_node('ask', props={'name': 'ask'})
